...
pub fn deposit(test: &SoroswapPairTest, amount_0: &i128, amount_1: &i128){
...
fn deposit_basic() {
    ...
    let original_0 = test.token_0.balance(&test.user);
    let original_1 = test.token_0.balance(&test.user);
    let amount_0 = 1_000_000_000_000_000_000;
    let amount_1 = 4_000_000_000_000_000_000;
    let expected_liquidity = 2_000_000_000_000_000_000;
    ...
    // New balances:
    assert_eq!(test.token_0.balance(&test.user), original_0 - amount_0);
    assert_eq!(test.token_1.balance(&test.user), original_1 - amount_1);
